...
const twelvePixelRatioH = 74.6; //
const sixteenPixelRatioH = 56; //
const twentyPixelRatioH = 44.8;  //
const twentyFivePixelRatioH = 35.84; //
const thirtyPixelRatioH = 29.8; //
const thirtyTwoPixelRatioH = 28;  //
...
const fiveHundredPixelRatioH = 1.792; //
